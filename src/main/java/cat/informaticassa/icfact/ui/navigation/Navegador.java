...
public class Navegador {
    ...
    private void configurarStage() {
        ...
        stage.setWidth(Tema.FINESTRA_AMPLADA);
        stage.setHeight(Tema.FINESTRA_ALCADA);
        stage.setMinWidth(Tema.FINESTRA_AMPLADA);
        stage.setMinHeight(Tema.FINESTRA_ALCADA);
    ...
    public void mostrarPrincipal() {
        mostrar(new MainView());
    }

    private void mostrar(Parent vista) {
        stage.setScene(new Scene(vista, Tema.FINESTRA_AMPLADA, Tema.FINESTRA_ALCADA));
    }
