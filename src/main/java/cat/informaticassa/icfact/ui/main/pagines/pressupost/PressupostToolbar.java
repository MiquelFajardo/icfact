...
@Getter
public class PressupostToolbar extends VBox {
    private final Label titol = new Label("Pressupostos");
    private final TextField txtBuscar = new TextField();
    private final CheckBox chkActius = new CheckBox("Actius");
    private final CheckBox chkInactius = new CheckBox("Inactius");
    private final BotoPrimari botoNou = new BotoPrimari("Nou pressupost");

    public PressupostToolbar() {
        setSpacing(15);
