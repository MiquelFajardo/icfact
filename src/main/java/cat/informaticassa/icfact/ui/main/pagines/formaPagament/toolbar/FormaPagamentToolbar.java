package cat.informaticassa.icfact.ui.main.pagines.formaPagament.toolbar;
...
@Getter
public class FormaPagamentToolbar extends VBox {

    private final Label titol = new Label("Formes de pagament");
    ...
    private final BotoPrimari botoNou = new BotoPrimari("Nova forma de pagament");

    public FormaPagamentToolbar() {
        ...
        txtBuscar.setPromptText("Buscar per nom...");
