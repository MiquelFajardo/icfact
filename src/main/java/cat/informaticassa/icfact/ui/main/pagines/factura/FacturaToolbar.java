...
@Getter
public class FacturaToolbar extends VBox {
    private final Label titol = new Label("Factures");
    private final TextField txtBuscar = new TextField();
    private final CheckBox chkActius = new CheckBox("Actius");
    private final CheckBox chkInactius = new CheckBox("Inactius");
    private final BotoPrimari botoNou = new BotoPrimari("Nova factura");

    public FacturaToolbar() {
        setSpacing(15);
        ...
        txtBuscar.setPromptText("Buscar per número, client o observacions...");
        Region espai = new Region();
        HBox.setHgrow(espai, Priority.ALWAYS);
        HBox primeraFila = new HBox(titol, espai, botoNou);
        primeraFila.setAlignment(Pos.CENTER_LEFT);
        Region espai2 = new Region();
        HBox.setHgrow(espai2, Priority.ALWAYS);
        HBox segonaFila = new HBox(txtBuscar, espai2, chkActius, chkInactius);
