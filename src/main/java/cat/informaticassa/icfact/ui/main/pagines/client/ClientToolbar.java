...
@Getter
public class ClientToolbar extends VBox {

    private final Label titol = new Label("Clients");
    ...
    private final BotoPrimari botoNou = new BotoPrimari("Nou client");
    ...
    public ClientToolbar() {
        ...
        txtBuscar.setPromptText("Buscar per nom, NIF, telèfon o email...");
