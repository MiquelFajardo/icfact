...
public class PdfCapcaleraFactura {
    ...
    public void afegir(Document document, Factura factura, Empresa empresa) {
        ...
        try {
            ...
            if (factura.getClient().getAdreca() != null) {
                ...
                if (factura.getClient().getAdreca().getPoblacio() != null) {
                    ...
                    poblacio = factura.getClient()
                            .getAdreca()
                            .getPoblacio()
                            .getNom();

                    codiPostal = factura.getClient()
                            .getAdreca()
                            .getPoblacio()
                            .getCodiPostal()
                            .stream()
            ...
            if (empresa.getAdreca() != null) {
                ...
                if (empresa.getAdreca().getPoblacio() != null) {
                    ...
                    poblacioEmpresa = empresa.getAdreca()
                            .getPoblacio()
                            .getNom();
            ...
            if (empresa.getTelefon() != null
                    && !empresa.getTelefon().isBlank()) {
